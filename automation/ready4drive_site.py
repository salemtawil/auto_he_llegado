...
class Ready4DriveSite(BaseSite):
    ...
    def clone_for_run(self) -> Ready4DriveSite:
        return Ready4DriveSite(
    ...
    def _execute_iframe_flow(
        ...
        *,
        ...
        try:
            ...
            self._record_run_stat("final_result_started", url=page.url)
            ...
            self._record_run_stat("final_result_done", success=result.success, final_status=result.final_status, url=page.url)
            if session is not None:
